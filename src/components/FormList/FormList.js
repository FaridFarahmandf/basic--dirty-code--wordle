...
import SecondFormList from "./SecondFormList";
const FormList = () => {
  ...
  const [firstFieldSet,setFirstFieldSet] = useState("")
  const [secondFieldSet,setSecondFieldSet] = useState("disable")
  ...
  return (
    <div className="formWord">
      ...
      <SecondFormList fieldsetDisable={secondFieldSet} setFieldSetDisable={setSecondFieldSet}/>
    </div>
  );
};
